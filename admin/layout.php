        ...
        <div class="admin-shell">
            <aside class="admin-sidebar">
                ...
                <div class="admin-sidebar-footer">
                    ...
                    <a href="logout.php" class="mt-4 block rounded-md border border-slate-300 px-3 py-2 text-center text-sm font-medium hover:bg-slate-50">
                        ออกจากระบบ
                    </a>
                </div>
            </aside>
            ...
            <div class="admin-main">
                <header class="admin-topbar">
                    ...
                    <a href="logout.php" class="rounded-md border border-slate-300 px-3 py-2 text-sm font-medium hover:bg-slate-50 md:hidden">
                        ออกจากระบบ
                    </a>
                </header>
